...
from psycopg2-binary._psycopg import ProgrammingError, InterfaceError
from psycopg2-binary.extensions import ISQLQuote, adapt, register_adapter
from psycopg2-binary.extensions import new_type, new_array_type, register_type
...
def register_range(pgrange, pyrange, conn_or_curs, globally=False):
    ...
    *pgrange* type and raises `~psycopg2-binary.ProgrammingError` if the type is not
