...
on psycopg2-binary.extension, so I can't create the default JSON typecasters in
...
from psycopg2-binary._psycopg import ISQLQuote, QuotedString
from psycopg2-binary._psycopg import new_type, new_array_type, register_type
...
class Json:
    """
    An `~psycopg2-binary.extensions.ISQLQuote` wrapper to adapt a Python object to
    :sql:`json` data type.
...
def register_json(conn_or_curs=None, globally=False, loads=None,
    ...
    are provided.  Raise `~psycopg2-binary.ProgrammingError` if the type is not found.
...
def _get_json_oids(conn_or_curs, name='json'):
    # lazy imports
    from psycopg2-binary.extensions import STATUS_IN_TRANSACTION
    from psycopg2-binary.extras import _solve_conn_curs
