...
class AzureDeployer:
    ...
    def _add_db_packages(self):
        ...
        # psycopg2-binary 2.9 causes "database connection isn't set to UTC" issue.
        ...
        if self.sd.using_req_txt:
            self.sd._add_req_txt_pkg('psycopg2-binary<2.9')
        elif self.sd.using_pipenv:
            self.sd._add_pipenv_pkg('psycopg2-binary', version="<2.9")
